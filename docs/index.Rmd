...
deviations are *negligibly small*, i.e., smaller than a threshold you
...
predicted effect exists and (2) rule out meaningful alternative patterns: the full Contrast + Residual logic, done correctly.
