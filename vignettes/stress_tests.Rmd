...
vignette: >
  %\VignetteIndexEntry{Validation: Stress Tests}
...
```{r summary-bar, echo=FALSE, fig.width=5.5, fig.height=3.5}
...
```{r summary-heatmap, echo=FALSE, fig.width=5.5, fig.height=7}
